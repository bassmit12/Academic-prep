...
rem RegexGame commands
doskey rgcompile=java org.antlr.v4.Tool RegexGame.g4 -o gen
doskey rgbuild=javac -cp ".;lib/antlr-4.13.2-complete.jar" gen\RegexGame*.java RegexGame.java -d obj
doskey rgrun=java -cp "obj;lib/antlr-4.13.2-complete.jar" RegexGame
doskey rg=rgcompile $T rgbuild $T rgrun
