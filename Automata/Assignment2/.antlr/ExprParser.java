// Generated from d:/AP/Academic-prep/Automata/Assignment2/Expr.g4 by ANTLR 4.13.1
...
public class ExprParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, INT=3, MUL=4, DIV=5, ADD=6, SUB=7, FACT=8, POW=9, WS=10;
	public static final int
		RULE_expr = 0;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "INT", "MUL", "DIV", "ADD", "SUB", "FACT", "POW", "WS"
		};
	}
	...
	public static class FactorialContext extends ExprContext {
		...
		public TerminalNode FACT() { return getToken(ExprParser.FACT, 0); }
	...
	@SuppressWarnings("CheckReturnValue")
	public static class AddSubiContext extends ExprContext {
		public Token op;
		public List<ExprContext> expr() {
			return getRuleContexts(ExprContext.class);
		}
		...
		public AddSubiContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).enterAddSubi(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).exitAddSubi(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
		...
		try {
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 2:
						{
						_localctx = new AddSubiContext(new ExprContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_expr);
						setState(13);
						if (!(precpred(_ctx, 5))) throw new FailedPredicateException(this, "precpred(_ctx, 5)");
						setState(14);
						((AddSubiContext)_localctx).op = _input.LT(1);
						_la = _input.LA(1);
						if ( !(_la==ADD || _la==SUB) ) {
							((AddSubiContext)_localctx).op = (Token)_errHandler.recoverInline(this);
						}
						else {
							if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
							_errHandler.reportMatch(this);
