...
public interface ExamGrammarListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterListLiteral(ExamGrammarParser.ListLiteralContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ListLiteral}
	 * labeled alternative in {@link ExamGrammarParser#primaryExpr}.
	 * @param ctx the parse tree
	 */
	void exitListLiteral(ExamGrammarParser.ListLiteralContext ctx);
	/**
	 * Enter a parse tree produced by the {@code StringLiteral}
	 * labeled alternative in {@link ExamGrammarParser#primaryExpr}.
	 * @param ctx the parse tree
	 */
	void enterStringLiteral(ExamGrammarParser.StringLiteralContext ctx);
	/**
	 * Exit a parse tree produced by the {@code StringLiteral}
	 * labeled alternative in {@link ExamGrammarParser#primaryExpr}.
	 * @param ctx the parse tree
	 */
	void exitStringLiteral(ExamGrammarParser.StringLiteralContext ctx);
	/**
